            ...
            <sprzedaż>
                ...
                <xsl:for-each select="tabela-płyt/płyty/płyta">
                    ...
                    <płyta>
                        ...
                        <cena>
                            <xsl:variable name="cena" select="cena"/>
                            <xsl:variable name="waluta" select="../@waluta"/>
                            <xsl:value-of select='concat(format-number($cena, "#,00"), " ", $waluta)'/>
                        </cena>
                    </płyta>
                </xsl:for-each>
            </sprzedaż>
